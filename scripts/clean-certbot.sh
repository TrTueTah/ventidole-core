...
echo ""
echo "📝 Next steps:"
echo "  1. Ensure DNSSEC is fully disabled (check: dig api.ventidole.xyz +short)"
echo "  2. Try HTTP-01 challenge:"
echo "     sudo certbot certonly --standalone -d api.ventidole.xyz --agree-tos --email your-email@example.com"
echo ""
echo "  OR if DNSSEC still broken:"
echo "  3. Use DNS-01 challenge:"
echo "     sudo certbot certonly --manual --preferred-challenges dns -d api.ventidole.xyz --agree-tos --email your-email@example.com"
echo ""
